...
<html>
    <head>
        ...
        <title>Cadastro categoria Patrocinadores</title>
    ...
    <body onload="relogio();">
        <center>
            ...
            %>
        <a class="texto1">Cadastro categoria Patrocinadores</a><br><br>
            <form method="post">
             ...
             <a class="texto3">Titulo:</a> <input type="text" name="Titulo" value="<%=categoriaPatrocinadores_BEAN.getTitulo()%>"><br>
