...
function rolagemAvancar(id,pixels){
    var limite=document.getElementById(id).scrollHeight;
    var posicao=document.getElementById(id).scrollTop;
    if((posicao+pixels)>limite){
        posicao=limite;
    }
    else{
        posicao=posicao+pixels;
    }
    document.getElementById(id).scrollTop=posicao;
}
function rolagemVoltar(id,pixels){
    var limite=0;
    var posicao=document.getElementById(id).scrollTop;
    if((posicao-pixels)<limite){
        posicao=0;
